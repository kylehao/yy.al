...
if (window.lovelygallery == undefined)
{
	(function(b,j){var e=function(){return new e.fn.init};e.fn=e.prototype={version:"1.0.1",constructor:e,init:function(){return this}};e.fn.init.prototype=e.fn;j.lovelygallery=e})(jQuery,window);
	...
	c.version}else{h=navigator.userAgent;if((g=h.match(/(opera|chrome|safari|firefox)\/?\s*(\.?\d+(\.\d+)*)/i))&&null!=(d=h.match(/version\/([\.\d]+)/i)))g[2]=d[1];g=g?g[2]:navigator.appVersion;c.version=new String(g);c.version.high=parseInt(c.version)}e.browser=c})(jQuery,lovelygallery);
	...
	decodeURIComponent(h[2]);return c},same_domain:function(b,c){var a=b.match(/^(https?:\/\/)?([\da-z\.-]+)\/?/),h=c.match(/^(https?:\/\/)?([\da-z\.-]+)\/?/);alert(h);return void 0==a[3]||void 0==h[3]?!1:a[3].toLower()==h[3].toLower()}}})(jQuery,lovelygallery);
}
...
var g=a.theme&&"default"!=a.theme?" lovelygallery-theme-"+a.theme:"";if(0<a.startCount){var e=j().utility.get_cookie("lovelygallery-popup-start-count"),e=e?e:0;if(e>=a.startCount)return;e++;j().utility.set_cookie("lovelygallery-popup-start-count",e,a.interval)}b("body").addClass("lovelygallery-popup-ready");f=b(document.createElement("div"));f.addClass("lovelygallery-container"+g);d.container=f;a.css3Effects&&"none"!=a.css3Effects&&f.addClass("lovelygallery-effect-"+a.css3Effects.toLowerCase());f.css({display:"none",width:a.width?a.width:
"auto",height:a.height?a.height:"auto","min-width":150,"min-height":150,left:"center"==a.left?"50%":a.left,top:"center"==a.top?"50%":a.top});f.appendTo("body");a.caption&&""!=a.caption&&(e=b(document.createElement("p")),e.addClass("lovelygallery-popup-caption"),e.html(a.caption),f.append(e));s=b(document.createElement("div"));s.addClass("lovelygallery-popup-loading");f.append(s);r=b(document.createElement("div"));r.addClass("lovelygallery-content-holder");r.appendTo(f);var k;e=a.buttons;if(b.isArray(e)&&0<e.length){var l=
["html","action"],n=b(document.createElement("div"));n.addClass("lovelygallery-popup-custom-buttons");for(var p=0;p<e.length;p++){var m=b(document.createElement("a"));m.attr("href","javascript: void(0);");e[p].html&&m.html(e[p].html);for(k in e[p])-1==l.indexOf(k)&&m.attr(k,e[p][k]);b.isFunction(e[p].action)&&m.click(e[p].action);n.append(m)}k=n}else k=!1;!1!==k&&f.append(k);k=c();d.setContent("html"!=k?a.href:a.htmlContent,k);a.close&&(q=b(document.createElement("a")),q.addClass("lovelygallery-ui-close"),q.attr("href",
"javascript: void(0);"),q.click(function(b){a.onClose(b);d.hidePopup()}),q.html(a.closeCaption),f.append(q));a.overlay&&(t=b(document.createElement("div")),t.addClass("lovelygallery-overlay"+g),t.appendTo("body"),d.overlay=t,"object"==typeof a.overlay&&b.extend({opacity:0.7,zindex:1E4},a.overlay),a.overlayClose&&t.click(function(b){a.onClose(b);d.hidePopup()}));this.modules.execute(d,a);a.onBeforeShow(f.get(0));d.centerPopup();b(window).resize(function(){d.centerPopup()});d.showPopup();setTimeout(function(){d.centerPopup()},
...
height:m}};return this}};c.fn.init.prototype=c.fn;c.fn.events=new function(){var a=jQuery(this);this.bind=function(b,c,d){return a.bind(b,c,d)};this.unbind=function(b,c){return a.unbind(b,c)};this.trigger=function(b,c){return a.trigger(b,c)}};j.fn.popup=c})(jQuery,lovelygallery);
$.fn.lovelygalleryPopup=function(b){b.href&&null==b.useFrame&&(b.useFrame=!0);if("random"==b.css3Effects){var j="none zoomIn zoomOut flip flipInHor flipInVer bounceIn pageTop flyIn fadeInScale scaleDown fadeSpin pulse leftSpeedIn rollIn rollOut pulseBody fadeSpinBody".split(" ");b.css3Effects=j[Math.floor(Math.random()*(j.length-1))]}b=$.extend(!0,{width:null,height:null,left:"center",top:"center",close:!0,closeCaption:"",theme:"default",htmlContent:"<p> Default content </p>",esc:!0,overlay:{opacity:0.75,
zindex:1E5},caption:null,href:null,overlayClose:!0,autoClose:!1,autoShow:!1,startCount:0,interval:30,effectIn:"none",effectOut:"none",css3Effects:!1,showOnEvent:"click",useFrame:!1,useAjax:!1,loadingImage:!1,unload:!1,draggable:!1,responsive:!0,ajaxContent:{url:"",type:"POST",data:null},groupGallery:!1,groupIndex:0,groupAutoPlay:!0,groupWait:5E3,loop:!0,buttons:null,onBeforeShow:function(){},onShow:function(){},onComplete:function(){},onHide:function(){},onClose:function(){}},b);var e=null;!this.data("unique-lovelygallery-instance")||
b.unload?(e=lovelygallery().popup(b),b.autoShow?setTimeout(function(){e.create_popup()},b.autoShow):e.create_popup(),this.data("unique-lovelygallery-instance",e)):(e=this.data("unique-lovelygallery-instance"),b.autoShow?setTimeout(function(){e.showPopup()},b.autoShow):(e.showPopup(),e.centerPopup()));return e};
$(function(){$.lovelygalleryPopup={};$.lovelygalleryPopup.smartSkins={};$.lovelygalleryPopup.browser_ie=lovelygallery().browser.is_ie;$.lovelygalleryPopup.registerSmartSkin=function(b,j){$.lovelygalleryPopup.smartSkins[b]=j};$(document).on("click tap",".lovelygallery-popup",function(b){b.preventDefault();var j=$(this);b=j.attr("href");var e=[],c=j.attr("rel");c&&""!=c&&$('.lovelygallery-popup[rel="'+c+'"]').each(function(){var a=$(this);a.get(0);j.get(0);e.push({url:a.attr("href"),title:a.attr("title")})});c=void 0!=$(this).data("lovelygalleryOptions")?$(this).data("lovelygalleryOptions"):
lovelygallery().utility.query_parameters(b);c=$.extend({htmlContent:!1,effectIn:"fade",effectOut:"fade"},c);c.useAjax&&(c.ajaxContent={url:b,type:"GET",data:null});c.href=b;$(this).lovelygalleryPopup(c)})});
(function(b,j){var e=function(){return new e.fn.init};e.fn=e.prototype={version:"1.0.1",constructor:e,init:function(){var c={};this.register_module=function(a,b){c[a]=b};this.deregister_module=function(a){c[a]=null};this.clear=function(){c={}};this.execute=function(a,e){for(key in c){var g=c[key];b.isFunction(g)&&(g=g.apply(a,[e]),null!=g&&g.init())}return null};return this}};e.fn.init.prototype=e.fn;j.fn.modules=e()})(jQuery,lovelygallery().popup);
(function(b,j){j.fn.modules.register_module("draggable",function(e){function c(b){var c=l.position();d.bind("mousemove",{startX:b.clientX,startY:b.clientY,offset:c},a).bind("mouseup",h)}function a(a){var b=a.data.offset;l.css({left:a.clientX-a.data.startX+b.left,top:a.clientY-a.data.startY+b.top})}function h(){d.unbind("mousemove",a).unbind("mouseup",h)}var g=null,d=b(window),l=this.container;this.init=function(){e.draggable&&(g=b(document.createElement("div")),g.addClass("lovelygallery-popup-drag-area"),
g.bind("mousedown",c),l.append(g))};return this})})(jQuery,lovelygallery().popup);
(function(b,j,e){j.fn.modules.register_module("effects",function(c){function a(a,f,h,g,k){if(f&&"none"!=f&&(!e().browser.is_ie||9<e().browser.is_ie)){var m=function(){b.isFunction(k)&&k();d.unbind("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",m)};d.bind("animationend webkitAnimationEnd MSAnimationEnd oAnimationEnd",m);h?(d.show(),l&&l.show(),b("body").addClass("lovelygallery-effect-"+f.toLowerCase()+"-active"),d.removeClass("lovelygallery-effect-"+f.toLowerCase()+"-reverse"),d.addClass("lovelygallery-effect-"+
f.toLowerCase()+"-normal")):(b("body").removeClass("lovelygallery-effect-"+f.toLowerCase()+"-active"),d.addClass("lovelygallery-effect-"+f.toLowerCase()+"-reverse"),d.removeClass("lovelygallery-effect-"+f.toLowerCase()+"-normal"),l&&!g&&l.hide());d.css({"-webkit-animation-play-state":"running","-moz-animation-play-state":"running","-o-animation-play-state":"running","-ms-animation-play-state":"running","animation-play-state":"running"});return!0}return a&&"none"!=a?(b.isFunction(a)?c.overlay?a(d.get(0),l.get(0)):a(d.get(0)):
...
height:"toggle"},g);break;case "incerto":h?(d.css("left",k+f/2),d.stop().animate({width:"toggle",left:k},c,g),d.css("top",m+q/2),d.animate({top:m},c,g)):(d.stop().animate({top:m+q/2},c,g),d.animate({width:"toggle",left:k+f/2},c,g));break;default:a=h?"fadeIn":"fadeOut",d.stop(),d[a](c,g)}l&&l.stop().animate({opacity:"toggle"},c,function(){!0==e().browser.is_ie&&8>=e().browser.version.high&&l.get(0).style.removeAttribute("filter",!1)})};return j})})(jQuery,lovelygallery().popup,lovelygallery);
(function(b,j,e,c){j.fn.modules.register_module("smartskin",function(a){function e(){j.SmartSkin.run_skin(a.theme,l);if(void 0!=b.lovelygalleryPopup.smartSkins[a.theme])b.lovelygalleryPopup.smartSkins[a.theme](d,g)}b(c);var g=this.container,d=this.overlay,l=this;this.init=function(){l.extend.add_action("show",e)};return l});j.SmartSkin=new function(){var a={};this.register_skin=function(b,c){a[b]=c};this.run_skin=function(b,c){if(void 0!=a[b])a[b](c.overlay,c.container)}}})(jQuery,lovelygallery().popup,lovelygallery,window);
...
d.audio_element=g};this.play_audio=function(){null!=d.audio_element&&d.audio_element.get(0).play()};this.stop_audio=function(){null!=d.audio_element&&d.audio_element.get(0).pause()};this.get_audio_element=function(){return this.audio_element};return d})})(jQuery,lovelygallery().popup,lovelygallery,window);
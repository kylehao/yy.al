...
img.stop2t_off = new Image();
img.stop2t_off.src = "./img/btn_stop2.gif";
img.stop2t_on = new Image();
img.stop2t_on.src = "./img/btn_stop2_on.gif";
img.stop2t_ovr = new Image();
img.stop2t_ovr.src = "./img/btn_stop2_ovr.gif";
...
if(tg=="stop2t") { if(act=="2"){imgstop2(2);} else {imgstop2();} }
...
function imgstop2(f){
var wmps=Exobud.playState;
if(f==2){imgChange("stop2t",2);}
else {
if(wmps==2 || wmps==3){imgChange("stop2t",0);}
else {imgChange("stop2t",1);}
}
}
